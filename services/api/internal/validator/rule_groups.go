...
func UsernameRule(lang string, field string, required bool) []validation.Rule {
	rules := []validation.Rule{
		LengthRule(lang, field, username.MinUserNameLength, username.MaxUserNameLength),
		FormatRule(lang, field, username.UserNameRegex),
	}
